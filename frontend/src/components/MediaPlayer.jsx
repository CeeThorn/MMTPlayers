...
const MediaPlayer = ({ id, url, volume = 1, onDelete, updatePlayerRef }) => {
  ...
  }, [id, type, videoRef.current, audioRef.current, ytRef.current, updatePlayerRef, id]);
...
function extractYouTubeId(url) {
  ...
  try {
    ...
    // If proxied URL: ?url=https://www.youtube.com/...
    const original = urlObj.searchParams.get("url") || url;
    
    // Standard watch URL or youtu.be
    const patterns = [
